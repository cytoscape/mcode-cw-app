...
exports.useMcodeResultActions = useMcodeResultActions;
/**
...
const ExportApi_1 = require("cyweb/ExportApi");
const NetworkApi_1 = require("cyweb/NetworkApi");
const WorkspaceApi_1 = require("cyweb/WorkspaceApi");
const mcodeExport_1 = require("./mcodeExport");
function useMcodeResultActions(selectedResult, selectedCluster) {
    const workspaceApi = (0, WorkspaceApi_1.useWorkspaceApi)();
    const networkApi = (0, NetworkApi_1.useNetworkApi)();
    const exportApi = (0, ExportApi_1.useExportApi)();
    const elementApi = (0, ElementApi_1.useElementApi)();
    const viewSourceNetwork = (0, react_1.useCallback)(() => {
        if (!selectedResult)
            return;
    ...
    const createClusterNetwork = (0, react_1.useCallback)(() => {
        ...
        const cxData = (0, mcodeExport_1.sliceClusterCx2)(exported.data, selectedCluster.nodes, selectedCluster.nodePositions);
    ...
    const exportResult = (0, react_1.useCallback)(() => {
        if (!selectedResult)
            return;
        ...
        const content = (0, mcodeExport_1.buildMcodeResultsText)(parameters, rows);
